      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-md animate-slide-up">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-graphite-50">SubManager</h1>
          ...
          <div className="bg-graphite-900 border border-graphite-800 rounded-2xl p-6 shadow-2xl">
            <h2 className="text-xl font-semibold text-graphite-100 mb-1">
              {adminExists ? "Вход в панель" : "Создание администратора"}
            </h2>
            <p className="text-graphite-400 text-sm mb-6">
              {adminExists
                ? "Введите учетные данные для входа"
                : "Первый ввод создаст учётную запись администратора"}
            </p>
