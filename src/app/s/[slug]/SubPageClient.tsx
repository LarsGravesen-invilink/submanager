        ...
        <div className="mt-4 space-y-2">
          {hasWhatsNew && (
            <button
              ...
              className="group flex w-full items-center justify-between rounded-xl border border-[#F0B900]/25 bg-[#F0B900]/[0.045] px-4 py-2 text-left text-xs font-semibold text-[#F0B900] shadow-[0_0_14px_rgba(240,185,0,0.07)] transition-colors hover:border-[#F0B900]/45 hover:bg-[#F0B900]/[0.08]"
            >
              <span>Изменения</span>
              <svg className="h-3.5 w-3.5 flex-shrink-0 transition-transform group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </svg>
            </button>
          )}
          <button
            ...
            className="group flex w-full items-center justify-between rounded-xl border border-[#F0B900]/20 bg-white/[0.035] px-4 py-2 text-left text-xs font-semibold text-white/75 shadow-[0_0_14px_rgba(240,185,0,0.06)] transition-colors hover:border-[#F0B900]/45 hover:bg-[#F0B900]/[0.07] hover:text-white"
          >
            <span>Что-то не работает?</span>
            <svg className="h-3.5 w-3.5 flex-shrink-0 text-[#F0B900]/75 transition-transform group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
            </svg>
          </button>
          <button
            onClick={() => setShowDisclaimer(true)}
            className="group flex w-full items-center justify-between rounded-xl border border-[#F0B900]/20 bg-white/[0.035] px-4 py-2 text-left text-[11px] font-medium text-white/60 shadow-[0_0_14px_rgba(240,185,0,0.06)] transition-colors hover:border-[#F0B900]/45 hover:bg-[#F0B900]/[0.07] hover:text-white/85"
          >
